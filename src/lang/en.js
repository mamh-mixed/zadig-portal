...
exports.default = {
  global: {
    ...
    keyIsDuplicated: 'Key is duplicated',
  ...
  workflow: {
    ...
    fromJobDiffTitle: 'When executing, the image information in values will be replaced by the image information generated by the preceding {name} task',
    jobNotReady: 'Task not configured'
  },
  webhookType: {
    dingding: 'DingDing',
    wechat: 'Wechat',
  ...
  sysSetting: {
    integration: {
      accountTab: 'Account System',
      accountTip: 'Support integration with Microsoft Active Directory, OpenLDAP, GitHub, and OAuth for external account systems',
      projectTab: 'Project Management',
      projectTip: 'Support integration with Jira and Feishu project management systems',
      gitProviderTab: 'Code Source',
      gitProviderTip: 'Support integration with code sources, including GitLab, GitHub, Gerrit, Gitee (Community Edition), and Gitee (Enterprise Edition)',
      configTab: 'Configuration Management',
      configTip: 'Support integration with Nacos and Apollo configuration management systems',
      ciTab: 'CI/CD Tool: Jenkins',
      ciTip: 'Support integration with Jenkins Server, allowing workflows to use Jenkins Job to build images',
      scannerTab: 'Code Scanner: SonarQube/Other',
      scannerTip: 'Support integration with Sonar Server, allowing the use of SonarQube for code scanning and uploading results to the integrated address',
      approvalTab: 'Approval System',
      approvalTip: 'Support integration with Feishu and DingTalk approval flows, providing the ability to perform approvals within IM',
      registryTab: 'Image Registry',
      registryTip: 'Support integration with Alibaba Cloud ACR, Tencent Cloud TCR, Huawei Cloud SWR, Amazon ECR, DockerHub, Harbor, JFrog, Nexus, and other image registries',
      storageTab: 'Object Storage',
      storageTip: 'Support integration with Alibaba Cloud OSS, Tencent Cloud COS, Huawei Cloud OBS, Qiniu Cloud KODO, and other object storage systems that comply with the Amazon S3 protocol',
      helmChartRepoTab: 'Helm Chart Repository',
      helmChartRepoTip: 'Support integration with self-built Harbor repositories and chart repositories provided by Alibaba, Tencent, Huawei, and other cloud vendors',
      clusterTab: 'Kubernetes Cluster',
      clusterTip: 'Support access and usage of K8s clusters such as Alibaba Cloud ACK, Tencent Cloud TKE, Tencent Cloud TKE Serverless, Huawei Cloud CCE, Amazon EKS, and Azure AKS',
      hostTab: 'Host Management',
      hostTip: 'Support access and usage of hosts such as Alibaba Cloud ECS, Tencent Cloud CVM, and Huawei Cloud ECS',
      externalSystemTab: 'Other Systems',
      externalSystemTip: 'Support integration with other external systems, allowing workflows to call external system APIs after configuration',
      gitProviders: {
