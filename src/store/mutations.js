...
export const SET_CUROPERATETYPE = 'SET_CUROPERATETYPE'
export const SET_WORKFLOW_INFO = 'SET_WORKFLOW_INFO'
export const SET_MASK_STATUS = 'SET_MASK_STATUS'

// Plutus
export const SET_HAS_PLUTUS = 'SET_HAS_PLUTUS'
export const SET_PLUTUS_CHECKED = 'SET_PLUTUS_CHECKED'
export const SET_SIGNATURE_FEATURE = 'SET_SIGNATURE_FEATURE'
