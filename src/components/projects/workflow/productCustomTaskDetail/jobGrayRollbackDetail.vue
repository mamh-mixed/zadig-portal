  ...
  <div class="job-gray-rollback">
    ...
    <main>
      ...
      <el-row class="item" :gutter="0">
        <el-col :span="4">
          <div class="item-title">Deployment 名称</div>
        </el-col>
        <el-col :span="8">
          <span class="item-desc">{{jobInfo.spec.workload_name}}</span>
        </el-col>
      </el-row>
      ...
      <el-row class="item">
        ...
        <el-col :span="8">
          <div class="item-desc">{{jobInfo.spec.total_replica}}</div>
        </el-col>
      </el-row>
    </main>
  </div>
