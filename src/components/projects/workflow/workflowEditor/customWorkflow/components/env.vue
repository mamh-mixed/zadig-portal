  ...
  <div class="global-env">
    <el-form ref="buildEnvRef" :inline="true" :model="preEnvs" class="variable-form" label-position="top" label-width="80px">
      <el-row :gutter="2" class="mg-b16">
        <el-col :span="4" class="title">类型</el-col>
        <el-col :span="4" class="title">键</el-col>
        <el-col :span="4" class="title">值</el-col>
      </el-row>
        ...
        <el-col :span="4">
          <el-form-item>
            <div class="app-operation">
              ...
              <!-- <el-button v-if="build_env_index===preEnvs.params.length-1" @click="addBuildEnv()" type="primary" size="small" plain>新增</el-button> -->
            </div>
          </el-form-item>
        </el-col>
      </el-row>
  ...
  methods: {
    ...
    addBuildEnv () {
      this.validate().then(valid => {
        ...
        this.$forceUpdate()
        console.log(this.preEnvs.params)
      })
    },
