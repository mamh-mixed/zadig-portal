              ...
              <template>
                <el-col :span="24">
                  ...
                  <el-tooltip v-else content="请求镜像失败，请手动输入镜像" placement="top" popper-class="gray-popper">
                    <el-input v-model="scope.row.image" class="short-input" size="small" style="width: 100%;" placeholder="请填写镜像"></el-input>
                  </el-tooltip>
                </el-col>
              </template>
            </el-row>
...
<script>
import virtualListItem from '@/components/projects/common/imageItem'
